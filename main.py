...
def prepare_data(path1, path2, join_col, join_type):
    ...
    # print joined table header, remove duplicated join column name,
    final_headers = ""
...
def inner_join(first_filepath, second_filepath, first_join_col_idx, second_join_col_idx):
    ...
    for first_row in first_gen:
        ...
        for second_row in second_gen:
            ...
            # prepare row to be joined to the left table
            row_to_join = second_row.replace(second_row_split[second_join_col_idx] + ",", "")
...
def perform_join(filepath1, filepath2, join_column, join_type):
    # data preparation
    first_join_col_idx, second_join_col_idx, final_headers = prepare_data(filepath1, filepath2, join_column, join_type)
...
if __name__ == "__main__":
    ...
    perform_join("data/loan.csv", "data/borrower.csv", "LOAN_NO", "right")
